		...
		<section class="hero is-hero-background is-fullheight">
			...
			<div class="hero-body">
				...
				<div class="container">
					...
					<form class="form" action="../../scripts/php/register/cadastrar_cidade.php" method="post" enctype="multipart/form-data">

						<h1 class="label has-text-centered">Cadastre uma Cidade</h1>

						<div class="control">
							<label class="label">Digite o nome da cidade: </label>
